...
<sql:query var="result3" dataSource="${snapshot}">
    select *from sysstandard where Status = (select Feature from userinfo where UserId = (select UserId from logininfo where UName='<%=session.getAttribute("user_now")%>'))-1
</sql:query>
<!-- 头部 -->
<div class="jumbotron">
    <div class="container">
