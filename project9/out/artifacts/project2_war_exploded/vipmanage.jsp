    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group" id="listgroup">
                ...
                <a href="vipmanage.jsp" class="list-group-item active">会员管理</a>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <% if(p.getFeature()=='1'){%>
                                <td>写者</td>
                            <%} else if(p.getFeature()=='2'){%>
                                <td>专委会管理员</td>
                            <%} else if(p.getFeature()=='3'){%>
                                <td>行业分会管理员</td>
                            <%} else if(p.getFeature()=='4'){%>
                                <td>研究会管理员</td>
                            <%}%>
                            <%--<td><% out.print( ( new java.sql.Date( p.getDeadline().getTime().getTime() ) ) ); %>	</td>--%>
                            <td><%=con.chkUserById(p.getReferrer()).getName()%></td>
