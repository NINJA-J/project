...
<sql:query var="result" dataSource="${snapshot}">
    select *from userinfo where Feature = '0' and CommitteeId = (select CommitteeId from userinfo where UserId = (select UserId from logininfo where UName='<%=session.getAttribute("user_now")%>'))
</sql:query>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group" id="listgroup">
                ...
                <c:forEach var="row" items="${result2.rows}">
                    <c:if test="${row.Feature!=1}">
                        <a href="personmanage.jsp" class="list-group-item active">申请管理</a>
