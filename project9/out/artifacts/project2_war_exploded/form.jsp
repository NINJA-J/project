    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group" id="listgroup">
                ...
                <a href="form.jsp" class="list-group-item active">提案编制</a>
                    ...
                    <form class="form-horizontal" method="get" action="check.jsp">
                        <div class="form-group" style="margin-top: 10px;margin-left: auto;margin-right: auto;width: 500px;height: 300px;">
                            ...
                            <div style="margin-top: 20px;">
                                <button type="submit" class="btn btn-primary" onclick="javascript:window.print()">打印</button>
                                <button type="submit" class="btn btn-primary" onclick="javascript:window.print()">保存</button>
                                <button type="submit" class="btn btn-primary">提交</button>
                                <%--<input id="btnPrintClick" value="打印" type="button" onclick="javascript:window.print()()"/>--%>
                            </div>
                        </div>
                    </form>
                </div>
