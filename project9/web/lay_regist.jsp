...
//    }
    if(!re.compare_reg("^1[\\d]{10}$",u_phone)){
    ...
    else if(!re.compare_reg("[^\\s]+",u_name)){
        pageContext.forward("pro_verify.jsp?error=Wrong_name");
    }
    else{
        Integer error = -1;
        ...
        error = con.addUser(
                ...
                request.getParameter("u_referee") == "" ? 0 : Integer.valueOf(request.getParameter("u_referee")),
        ...
        switch( error ){
            ...
            case SQLConnection.DATE_FORMAT_ERROR:                               %><<script type="text/javascript">
                ...
                break;
            default://case SQLConnection.SUCCESS:
