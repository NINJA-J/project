...
<%
  ...
  if(request.getParameter("proposal")==null) {
    pList = con.getProposalForAll();
  }
  else {
    pList = con.searchByTitle(request.getParameter("proposal"));
  }
        ...
        <div class="panel-heading">
          <form class="form-inline" action="index.jsp" method="get">
            <div class="form-group">
              <input type="text" class="form-control" name="proposal" placeholder="搜索提案">
            </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tr>
              ...
              <td><a href="detail.jsp?id=<%=p.getId()%>">详情</a></td>
            <%
              }
            %>
            </tr>
