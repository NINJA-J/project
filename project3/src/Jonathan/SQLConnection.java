...
public class SQLConnection {
	...
	//Login
	//鏌ヨ鐢ㄦ埛鍚嶅瘑鐮佸瓨鍦ㄥ瓨鍦紝杩斿洖鍊硷細
	//SQLConnection.SUCCESS			瀛樺湪涓旀纭�
	//SQLConnection.PSWD_ERROR		瀵嗙爜閿欒
	//SQLConnection.USER_INEXIST	鐢ㄦ埛鍚嶄笉瀛樺湪
	public int chkLoginInfo( String uName, String uPswd ) throws SQLException{
		boolean fPerson = false;
		st = con.createStatement();  //鏋勯�犺鍙ュ璞�
	...
	//绔嬪嵆娉ㄥ唽鐢ㄦ埛鍚嶅瘑鐮侊紝杩斿洖鍊硷細
	//SQLConnection.USER_EXIST		娉ㄥ唽鎴愬姛
	//SQLConnection.SUCCESS			鐢ㄦ埛鍚嶅凡瀛樺湪
	...
	/* 鏂板缓涓�浠芥彁妗堬紝杩斿洖鍊�
	 * SQLConnection.TITLE_EXIST	璇ユ爣棰樺凡瀛樺湪
	 * SQLConnection.USER_NO_FOUND	鍐欒�呬笉瀛樺湪
	 * SQLConnection.SUCCESS		鎴愬姛
	 * */
	...
	//涓篒D涓簆roposalId鐨勬彁妗堝鍔營D涓簊tandardId鐨勮鑼�
	...
	/* 娣诲姞涓�涓敤鎴风殑涓汉淇℃伅锛岃繑鍥炲��
 * SQLConnection.USER_EXIST			鍚屽悕锛堝疄鍚嶏級鐢ㄦ埛宸插瓨鍦�
 * SQLConnection.REFERRER_NO_FOUND	鎺ㄨ崘浜轰笉瀛樺湪
 * SQLConnection.DB_OPER_FAILURE	鏃ユ湡鏍煎紡閿欒
 * SQLConnection.DB_OPER_FAILURE	鏁版嵁搴撴搷浣滃け璐�
 * SQLConnection.SUCCESS			鎴愬姛
 * */
