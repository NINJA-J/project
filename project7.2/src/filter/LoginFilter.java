...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (
                !(re.compare_reg("/pro_login.jsp",targetURL) ||
                "/lay_login.jsp".equals(targetURL) ||
                "/lay_loginout.jsp".equals(targetURL) ||
                "/lay_signup.jsp".equals(targetURL) ||
                        re.compare_reg("/pro_verify.jsp",targetURL)||
                "/lay_regist.jsp".equals(targetURL) ||
                re.compare_reg("/standard.jsp",targetURL))
                )
        {
